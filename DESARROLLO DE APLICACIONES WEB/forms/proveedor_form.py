...
class ProveedorForm(FlaskForm):
    """
    Formulario para registrar y editar proveedores de AL WORK.
    ...
    tipo = StringField(
        'Tipo de proveedor',
        validators=[DataRequired(message='El tipo de proveedor es obligatorio.'),
                    Length(min=3, max=60, message='El tipo debe tener entre 3 y 60 caracteres.')]
    )
